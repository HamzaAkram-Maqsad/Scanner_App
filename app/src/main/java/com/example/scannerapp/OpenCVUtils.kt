...
//class OpenCVUtils {
//    companion object {
//        private fun getContourEdgePoints(bitmap: Bitmap): List<Point>? {
...
//
//            return if (hasContour) {
//                val pyrDownReceipt = convertMatToBitmap(matReceipt)
//                val widthRatio = bitmap.width.toDouble() / pyrDownReceipt.width.toDouble()
//                val heightRatio = bitmap.height.toDouble() / pyrDownReceipt.height.toDouble()
//
...
//                }
//            }
//            return pointList[pos].x.toDouble()
//        }
//
...
//                }
//            }
//            return pointList[pos].y.toDouble()
//        }
//
...
//            return kotlin.math.sqrt((point1.x - point2.x).toDouble() * (point1.x - point2.x) + (point1.y - point2.y) * (point1.y - point2.y))
//        }
//
...
//                corners.add(Point((cornerPoints[i].x * widthRatio),
//                    (cornerPoints[i].y * heightRatio)
//                ))
//            }
//
...
//        }
//
//        private fun getPointWithMaxCorY(listPoint: List<Point>?): Point? {
...
//        }
//
//        private fun getPointWithMinCorY(listPoint: List<Point>?): Point? {
